...
if [ ${MODE} = "lite_train_lite_infer" ];then
    ...
    elif [ ${model_name} == "rcan" ]; then
        wget -nc -P ./data/ http://data.vision.ee.ethz.ch/cvl/DIV2K/DIV2K_train_LR_bicubic_X4.zip --no-check-certificate
        wget -nc -P ./data/ http://data.vision.ee.ethz.ch/cvl/DIV2K/DIV2K_train_HR.zip --no-check-certificate
    fi
